<script>
    ...
    var events = []
    events.push(new Game.Evenement("Campagne de sensibilisation", "Souhaitez vous accepter la campagne de sensibilisation sur la surconsommation d'énergie ? ", new Game.Effect(-0.1, -0.2), new Game.Effect(0.02, 0.2)))
