<script>
    ...
    var events = []
    events.push(new Game.Evenement("Campagne de sensibilisation", "Souhaitez vous accepter la campagne de sensibilisation sur la surconsommation d'énergie ? ", new Game.Effect(-0.1, -0.02), new Game.Effect(0.02, 0.2)))
    events.push(new Game.Evenement("Révolte", "Souhaitez vous empecher la manifestation contre l'augmentation de la pollution", new Game.Effect(0.3, 0.4), new Game.Effect(-0.2, -0.2)))
    events.push(new Game.Evenement("Instauration d'une loi", "Souhaitez vous voter en faveur de la loi pour lutter contre la pollution", new Game.Effect(-0.2, 0.3), new Game.Effect(0.0, 0.0)))
    ...
    var upgrades = []
    upgrades.push(new Game.Upgrade("Usine de Traitement de déchets", 7, new Game.Effect(-0.2, -0.02)))
    upgrades.push(new Game.Upgrade("Agriculture bio", 6, new Game.Effect(-0.4, -0.025)))

    upgrades.push(new Game.Upgrade("Désinstallation Climatisation", 5, new Game.Effect(0.05, -0.02)))
    ...
    upgrades.push(new Game.Upgrade("Bioénergie", 2, new Game.Effect(0.1, 0.01)))
